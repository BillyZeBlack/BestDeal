...
class CategoryManager {
    ...
    let namesList : [String] = ["Divers","Mode","Nourriture","Electromenager","Bricolage","Multimédia","Meuble et déco","Jardin et maison","Informatique","Téléphonie","Jeux vidéo","Sport"]
